...
## Showing the Results
Finally, the fundamental frequency is obtained by finding the peak index and shown on the Oled Display along \
with the nearest note name and a dynamic bar that shows how far you are from the nearest note.
